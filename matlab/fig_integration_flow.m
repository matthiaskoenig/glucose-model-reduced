...
for k=1:Nc
    ...
    switch k
        case 1
            title('Glucose periportal', 'FontWeight', 'bold')
        case 2
            title('Lactate periportal', 'FontWeight', 'bold')
        case 3
...
for k=1:Nc
    ...
    switch k
        case 1
            title('fdata glc_{pp}', 'FontWeight', 'bold')
        case 2
            title('fdata lac_{pp}', 'FontWeight', 'bold')
        case 3
            title('fdata glc_{ext}', 'FontWeight', 'bold')
        case 4
            title('fdata lac_{ext}', 'FontWeight', 'bold')
        case 5
            title('fdata gly', 'FontWeight', 'bold')
    end
    axis square
    xlabel(strcat('time [', t_unit, ']'))
    ylabel('v [mM/s/L]')
